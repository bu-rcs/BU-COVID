...
## Contact tracing is also added in this simulation.
##
##
...
# Add an intervention that's required by the BU_quarantine_network_count
# snapshot
...
interventions.append(interv_contact_trace_log)
